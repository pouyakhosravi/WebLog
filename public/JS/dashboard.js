$(document).ready(function () {
    ...
    $("#writeArticle").click(function () {
        ...
        $.ajax({
            ...
            success: function (response) {
                window.location.href = window.location.origin + "/api/article/newArticle";
            },
            error: function (err) {
...
// get read page
function getReadPage(input) {
    $.ajax({
        type: "GET",
        url: `/api/article/readArticle/${input}`,
        success: function (readPage) {
            window.location.href = window.location.origin + `/api/article/readArticle/${input}`;
        },
        error: function (err) {
            console.log(err.responseText);
        }
